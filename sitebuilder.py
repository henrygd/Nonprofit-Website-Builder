...
# Sorry for the formatting! This function cobbles the site together along with
# the user submitted variables
def build(styles, logo, background, orgfont, showfont, bodyfont, butthov, logocolor,
    ...
    if background is None:
        ...
        if 'https' in background:
            backstretch1 = """<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-backstretch/2.0.4/jquery.backstretch.min.js"></script>"""
            backstretch2 = """\n<!-- background -->\n<script>$.backstretch("%s");</script>\n""" % (background)
            background = ''
        else:
            backstretch1, backstretch2 = '', ''
    ...
    <body id="page-top">
        ...
        orgname, showfont, orgfont, bodyfont, backstretch1, calendar, gcalscript, style, styles, butthov,
    ...
    part2 = """<!-- Contact Section -->
        ...
        twitterlink, mandrill_api, email, stripepk, stripepk, orgname, map2, backstretch2, calendarevents)
